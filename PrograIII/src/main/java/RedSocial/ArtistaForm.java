...
public class ArtistaForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JButton btnPublicar = button("Publicar", 20, 230, 120, new Color(150, 0, 150));
        ...
        JButton btnBaja = button("Darse de baja", 380, 415, 140, new Color(180, 60, 60));
    ...
    private void darseBaja() {
        ...
        mostrar("Aviso de baja enviado.", Color.RED);
    }
